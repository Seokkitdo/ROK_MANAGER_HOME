      ...
      <div>
        ...
        <container>
          <Col xs={12} sm={8} smOffset={2}>
            <Image src="assets/person-1.jpg" className="Update-profile-pic" rounded />
            ...
            <p>Anyone can paint. You can do anything here. So don't worry Update it. Life is too short to be alone, too precious. Share it with a friend. Every highlight needs it's own personal shadow.</p>
